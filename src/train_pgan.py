...
INIT_RESOLUTION = 32         # Image resolution used at the beginning training.
SAVE_IMG_STEP = 500
...
class PGGAN(object):
    ...
    def train(self, dataset_root):
        ...
        self.g_net.load_state_dict(torch.load("F:/GAN/src/output/Gnet_16x16.pth"))
        self.d_net.load_state_dict(torch.load("F:/GAN/src/output/Dnet_16x16.pth"))
...
if __name__ == "__main__":
    #gen_classified_images(r"C:/Users/Ole/Pictures/celeba/celeba", centre_crop=True, save_to_local=True)
